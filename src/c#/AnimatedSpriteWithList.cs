...
[XmlRoot("AnimatedSpriteWithList", Namespace = "http://www.univ-grenoble-alpes.fr/l3miage/spacePeace/AnimatedSpriteWithLists")]
[Serializable]

public class AnimatedSpriteWithList
{
    ...
    public AnimatedSpriteWithList(string texture, Vector2 position, int size, int nbAnimations)
    {
    ...
    public AnimatedSpriteWithList(string texture, Vector2 position, int height , int width, int nbAnimations) 
    {
        _listName = new List<string>(nbAnimations);
        string s;
        for(short i = 1; i < nbAnimations+1; i++)
